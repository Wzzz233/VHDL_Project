...
The RKNN path reads native FP16 outputs instead of expanding the two tensors to FP32. Candidate C uses a linear-time circular morphology implementation and reuses its scratch memory between frames.

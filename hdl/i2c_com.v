...
module i2c_com(clock_i2c        ,  //i2c控制接口传输所需时钟，0-400khz，此处为20khz
    ...
    begin
       ...
       begin
          ...
          case(cyc_count)
          0:begin ack1<=1;ack2<=1;ack3<=1;ack4<=1;tr_end<=0;sclk<=1;reg_sdat<=1;end
          1:reg_sdat<=0;                 //开始传输
          2:sclk<=0;
          ...
          20:reg_sdat<=1;                //应答信号       
          21:begin reg_sdat<=i2c_data[15];ack2<=i2c_sdat;end
          ...
          29:reg_sdat<=1;                //应答信号       
          30:begin reg_sdat<=i2c_data[7];ack3<=i2c_sdat;end
          ...
          38:reg_sdat<=1;                //应答信号       
          39:begin ack4<=i2c_sdat;sclk<=0;reg_sdat<=0;end
          40:sclk<=1;

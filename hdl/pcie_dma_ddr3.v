//pango参考例程
//基于官方demo修改 - 添加 DDR3 测试
module pcie_dma_ddr3 #(
...
//=============================================================================
// DDR3 Controller (AXI interfaces tied off - not used yet)
//=============================================================================
wire ddr_init_done;
wire core_clk_ddr;
...
DDR3_50H u_DDR3 (
    ...
    .axi_awaddr             ({MEM_ROW_ADDR_WIDTH+MEM_BADDR_WIDTH+MEM_COL_ADDR_WIDTH{1'b0}}),
    .axi_awuser_ap          (1'b0),
    .axi_awuser_id          (4'd0),
    .axi_awlen              (4'd0),
    .axi_awready            (),
    .axi_awvalid            (1'b0),
    .axi_wdata              ({MEM_DQ_WIDTH*8{1'b0}}),
    .axi_wstrb              ({MEM_DQ_WIDTH{1'b1}}),
    .axi_wready             (),
    .axi_wusero_id          (),
    .axi_wusero_last        (),
    
    // AXI Read channel - tied off
    .axi_araddr             ({MEM_ROW_ADDR_WIDTH+MEM_BADDR_WIDTH+MEM_COL_ADDR_WIDTH{1'b0}}),
    .axi_aruser_ap          (1'b0),
    .axi_aruser_id          (4'd0),
    .axi_arlen              (4'd0),
    .axi_arready            (),
